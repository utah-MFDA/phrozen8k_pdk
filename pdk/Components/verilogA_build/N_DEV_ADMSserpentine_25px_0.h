...
// Purpose        :
//
// Special Notes  : Generated from verilog file serpentine_25px_0.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSserpentine_25px_0_h
#define Xyce_N_DEV_ADMSserpentine_25px_0_h
...
namespace Xyce {
namespace Device {
namespace ADMSserpentine_25px_0 {
...
{
  static const char *name() {return "ADMS serpentine_25px_0";}
  static const char *deviceTypeName() {return "SERPENTINE_25PX_0 level 1";}
...
public:
  ...
  public:
    // iterator reference to the serpentine_25px_0 model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSserpentine_25px_0_h
