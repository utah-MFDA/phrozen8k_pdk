...
// Purpose        :
//
// Special Notes  : Generated from verilog file pressurePump.va with ADMS
//                  interface for Xyce 7.7.0
//                  DO NOT EDIT THIS FILE DIRECTLY!  It may be overwritten!
//
// Creator        : admsXml-2.3.7
//
// Creation Date  : Fri, 08 Nov 2024 11:10:31
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSpressurePump_h
#define Xyce_N_DEV_ADMSpressurePump_h
...
// instance parameters
// reals
double instancePar_pressure;
double d_instancePar_pressure_dX;
bool instancePar_given_pressure;
double instancePar_chemConcentration;
double d_instancePar_chemConcentration_dX;
bool instancePar_given_chemConcentration;
};
...
const int admsProbeID_I_fl_out_gnd,
// node constants
const int admsNodeID_fl_out,
const int admsNodeID_c_out,
const int admsBRA_ID_fl_out_gnd,
...
{
  static const char *name() {return "ADMS pressurePump";}
  static const char *deviceTypeName() {return "PRESSUREPUMP level 1";}
...
public:
  ...
  public:
    // iterator reference to the pressurePump model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
  ...
  private:
    ...
    // Jacobian  pointers
    double * f_fl_out_Equ_BRA_fl_out_gnd_Var_Ptr;
    double * f_c_out_Equ_BRA_c_out_gnd_Var_Ptr;
    double * f_BRA_fl_out_gnd_Equ_fl_out_Node_Ptr;
    double * f_BRA_c_out_gnd_Equ_c_out_Node_Ptr;
    double * q_fl_out_Equ_BRA_fl_out_gnd_Var_Ptr;
    double * q_c_out_Equ_BRA_c_out_gnd_Var_Ptr;
    double * q_BRA_fl_out_gnd_Equ_fl_out_Node_Ptr;
    double * q_BRA_c_out_gnd_Equ_c_out_Node_Ptr;
    // Jacobian offsets
    int A_fl_out_Equ_BRA_fl_out_gnd_Var_Offset;
    int A_c_out_Equ_BRA_c_out_gnd_Var_Offset;
    int A_BRA_fl_out_gnd_Equ_fl_out_Node_Offset;
    int A_BRA_c_out_gnd_Equ_c_out_Node_Offset;
    // end of Jacobian and pointers
   // node numbers
    static const int admsNodeID_fl_out = 0;
    static const int admsNodeID_c_out = 1;
    static const int admsNodeID_GND = -1;
   // end node numbers
   // Additional IDs for branch equations
    static const int admsBRA_ID_fl_out_gnd = 2;
    static const int admsBRA_ID_c_out_gnd = 3;
   // end branch numbers
   // Probe numbers
    static const int admsProbeID_I_c_out_gnd = 0;
    static const int admsProbeID_I_fl_out_gnd = 1;
   // end probe numbers
   // Store LIDs
   // end store LIDs
...
#endif //Xyce_N_DEV_ADMSpressurePump_h
