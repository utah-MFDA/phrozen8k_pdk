...
// Purpose        :
//
// Special Notes  : Generated from verilog file channel.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSchannel_h
#define Xyce_N_DEV_ADMSchannel_h
...
{
  static const char *name() {return "ADMS channel";}
  static const char *deviceTypeName() {return "CHANNEL level 1";}
...
public:
  ...
  public:
    // iterator reference to the channel model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSchannel_h
