...
// Purpose        :
//
// Special Notes  : Generated from verilog file p_serpentine_0.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSp_serpentine_0_h
#define Xyce_N_DEV_ADMSp_serpentine_0_h
...
{
  static const char *name() {return "ADMS p_serpentine_0";}
  static const char *deviceTypeName() {return "P_SERPENTINE_0 level 1";}
...
public:
  ...
  public:
    // iterator reference to the p_serpentine_0 model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSp_serpentine_0_h
