...
// Purpose        :
//
// Special Notes  : Generated from verilog file channel_flow.va with ADMS
//                  interface for Xyce 7.7.0
//                  DO NOT EDIT THIS FILE DIRECTLY!  It may be overwritten!
//
// Creator        : admsXml-2.3.7
//
// Creation Date  : Fri, 08 Nov 2024 11:10:32
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSchannel_flow_h
#define Xyce_N_DEV_ADMSchannel_flow_h
...
{
  static const char *name() {return "ADMS channel_flow";}
  static const char *deviceTypeName() {return "CHANNEL_FLOW level 1";}
...
public:
  ...
  public:
    // iterator reference to the channel_flow model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
  ...
  private:
   ...
   // end branch numbers
   // Probe numbers
    static const int admsProbeID_P_fl_in_fl_out = 0;
   // end probe numbers
   // Store LIDs
   // end store LIDs
...
#endif //Xyce_N_DEV_ADMSchannel_flow_h
