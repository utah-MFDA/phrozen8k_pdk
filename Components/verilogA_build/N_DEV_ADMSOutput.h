...
// Purpose        :
//
// Special Notes  : Generated from verilog file Output.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSOutput_h
#define Xyce_N_DEV_ADMSOutput_h
...
// probe constants
const int admsProbeID_C_c_out_GND,
const int admsProbeID_I_c_out_gnd,
// node constants
const int admsNodeID_c_out,
const int admsNodeID_gnd,
const int admsNodeID_c_term,
...
{
  static const char *name() {return "ADMS Output";}
  static const char *deviceTypeName() {return "OUTPUT level 1";}
...
public:
  ...
  public:
    // iterator reference to the Output model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
  ...
  private:
    ...
    double * f_gnd_Equ_BRA_c_out_gnd_Var_Ptr;
    double * f_BRA_c_out_gnd_Equ_c_out_Node_Ptr;
    double * f_BRA_c_out_gnd_Equ_gnd_Node_Ptr;
    double * q_c_out_Equ_BRA_c_out_gnd_Var_Ptr;
    double * q_gnd_Equ_BRA_c_out_gnd_Var_Ptr;
    double * q_BRA_c_out_gnd_Equ_c_out_Node_Ptr;
    double * q_BRA_c_out_gnd_Equ_gnd_Node_Ptr;
    // Jacobian offsets
    int A_c_out_Equ_BRA_c_out_gnd_Var_Offset;
    int A_gnd_Equ_BRA_c_out_gnd_Var_Offset;
    int A_BRA_c_out_gnd_Equ_c_out_Node_Offset;
    int A_BRA_c_out_gnd_Equ_gnd_Node_Offset;
    // end of Jacobian and pointers
   // node numbers
    static const int admsNodeID_c_out = 0;
    static const int admsNodeID_gnd = 1;
    static const int admsNodeID_c_term = 0+2;
    static const int admsNodeID_GND = -1;
   // end node numbers
   ...
   // end branch numbers
   // Probe numbers
    static const int admsProbeID_C_c_out_GND = 0;
    static const int admsProbeID_I_c_out_gnd = 1;
   // end probe numbers
   // Store LIDs
   // end store LIDs
