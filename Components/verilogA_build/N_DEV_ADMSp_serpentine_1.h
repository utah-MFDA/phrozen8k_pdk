...
// Purpose        :
//
// Special Notes  : Generated from verilog file p_serpentine_1.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSp_serpentine_1_h
#define Xyce_N_DEV_ADMSp_serpentine_1_h
...
double instancePar_lpv;
double d_instancePar_lpv_dX;
bool instancePar_given_lpv;
double instancePar_L1;
double d_instancePar_L1_dX;
bool instancePar_given_L1;
double instancePar_L2;
double d_instancePar_L2_dX;
bool instancePar_given_L2;
double instancePar_turns;
double d_instancePar_turns_dX;
bool instancePar_given_turns;
double instancePar_Lm;
double d_instancePar_Lm_dX;
bool instancePar_given_Lm;
...
{
  static const char *name() {return "ADMS p_serpentine_1";}
  static const char *deviceTypeName() {return "P_SERPENTINE_1 level 1";}
...
public:
  ...
  public:
    // iterator reference to the p_serpentine_1 model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
...
#endif //Xyce_N_DEV_ADMSp_serpentine_1_h
