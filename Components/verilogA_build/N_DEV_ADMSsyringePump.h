...
// Purpose        :
//
// Special Notes  : Generated from verilog file syringePump.va with ADMS
...
//
//-----------------------------------------------------------------------------
#ifndef Xyce_N_DEV_ADMSsyringePump_h
#define Xyce_N_DEV_ADMSsyringePump_h
...
// instance parameters
// reals
double instancePar_fluidflow;
double d_instancePar_fluidflow_dX;
bool instancePar_given_fluidflow;
...
{
  static const char *name() {return "ADMS syringePump";}
  static const char *deviceTypeName() {return "SYRINGEPUMP level 1";}
...
public:
  ...
  public:
    // iterator reference to the syringePump model which owns this instance.
    // Getters and setters
    Model &getModel()
    {
      return model_;
  ...
  private:
   ...
   // Additional IDs for branch equations
    static const int admsBRA_ID_c_out_gnd = 2;
   // end branch numbers
   // Probe numbers
...
#endif //Xyce_N_DEV_ADMSsyringePump_h
